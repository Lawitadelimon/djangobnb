                ...
                <div className="space-y-4">
                    <div className="p-5 grid grid-cols-1 md:grid-cols-4 gap-4 shadow-md border border-gray-300 rounded-xl">
                        ...
                        <div className="col-span-1 md:col-span-3">
                            ...
                            <p className="mb-2"><strong>Check in date:</strong> 24/02/2025</p>
                            <p className="mb-2"><strong>Check out date:</strong> 26/02/2025</p>

                            <p className="mb-2"><strong>Nomber of nights:</strong> 2</p>
